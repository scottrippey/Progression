...
namespace Progression
{
    public static class ProgressExtensions
    {
        ...
        /// <param name="taskArg">Provides additional info about the task being performed</param>
        /// <param name="callback">Attach a callback to the ProgressChanged event</param>
        public static IEnumerable<T> WithProgress<T>(this ICollection<T> source, string taskKey, object taskArg, ProgressChangedHandler callback)
        {
            return WithProgress(source, source.Count, taskKey, taskArg, callback);
        }
        ...
        /// <param name="taskArg">Provides additional info about the task being performed</param>
        /// <param name="callback">Attach a callback to the ProgressChanged event</param>
        public static IEnumerable<T> WithProgress<T>(this IEnumerable<T> source, int sourceCount, string taskKey, object taskArg, ProgressChangedHandler callback)
        {
            using (Progress.BeginTask(sourceCount))
            {
                if (taskKey != null) Progress.Update(taskKey, taskArg);
                if (callback != null) Progress.Update(callback);
        ...
        /// <param name="taskArg">Provides additional info about the task being performed</param>
        /// <param name="callback">Attach a callback to the ProgressChanged event</param>
        public static IEnumerable<T> WithProgress<T>(this IEnumerable<T> source, float[] stepProportions, string taskKey, object taskArg, ProgressChangedHandler callback)
        {
        ...
        /// <param name="taskArg">Provides additional info about the task being performed</param>
        /// <param name="callback">Attach a callback to the ProgressChanged event</param>
        public static IEnumerable<T> WithProgressUnknown<T>(this IEnumerable<T> source, float estimatedCount, float estimatedWeight, string taskKey, object taskArg, ProgressChangedHandler callback)
        {
    ...
    public static class ProgressExtensionsOverloads
    {
        ...
        {
            return ProgressExtensions.WithProgress(source, null, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source">The Count property will be used to calculate progress as items are enumerated.</param>
        /// <param name="taskKey">Identifies the task being performed.  Can be used for displaying progress.</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, taskKey, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source">The Count property will be used to calculate progress as items are enumerated.</param>
        /// <param name="taskKey">Identifies the task being performed.  Can be used for displaying progress.</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, taskKey, taskArg, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source">The Count property will be used to calculate progress as items are enumerated.</param>
        /// <param name="callback">Attach a callback to the ProgressChanged event</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, null, null, callback);
        }
        ...
        {
            return ProgressExtensions.WithProgress(source, sourceCount, null, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source"></param>
        /// <param name="sourceCount">Used to calculate progress as items are enumerated. If the count is unknown, use the "WithProgressUnknown" overload.</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, sourceCount, taskKey, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source"></param>
        /// <param name="sourceCount">Used to calculate progress as items are enumerated. If the count is unknown, use the "WithProgressUnknown" overload.</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, sourceCount, taskKey, taskArg, null);
        }
        /// <summary> Tracks progress as the source is enumerated. </summary>
        /// <param name="source"></param>
        /// <param name="sourceCount">Used to calculate progress as items are enumerated. If the count is unknown, use the "WithProgressUnknown" overload.</param>
        ...
        {
            return ProgressExtensions.WithProgress(source, sourceCount, null, null, callback);
        }
        ...
        {
            return ProgressExtensions.WithProgress(source, stepProportions, null, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// Progress is calculated proportionally for each step.
        /// </summary>
        ...
        {
            return ProgressExtensions.WithProgress(source, stepProportions, taskKey, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// Progress is calculated proportionally for each step.
        /// </summary>
        ...
        {
            return ProgressExtensions.WithProgress(source, stepProportions, taskKey, taskArg, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// Progress is calculated proportionally for each step.
        /// </summary>
        ...
        {
            return ProgressExtensions.WithProgress(source, stepProportions, null, null, callback);
        }
        ...
        {
            return ProgressExtensions.WithProgressUnknown(source, estimatedCount, estimatedWeight, null, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// 
        /// Since the number of items is unknown,
        ...
        {
            return ProgressExtensions.WithProgressUnknown(source, estimatedCount, estimatedWeight, taskKey, taskArg, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// 
        /// Since the number of items is unknown,
        ...
        {
            return ProgressExtensions.WithProgressUnknown(source, estimatedCount, estimatedWeight, taskKey, null, null);
        }
        /// <summary> Tracks progress as the source is enumerated.
        /// 
        /// Since the number of items is unknown,
        ...
        {
            return ProgressExtensions.WithProgressUnknown(source, estimatedCount, estimatedWeight, null, null, callback);
        }
    }
}
